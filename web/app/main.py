...
async def serve_dashboard():
    """Serve the dashboard HTML with a cache-busting query param for app.js.

    This ensures browsers fetch the latest `app.js` after edits during development.
    """
    try:
    ...
    # Append a timestamp to the static app.js reference to bust browser cache
    busted = html.replace('/static/app.js', f'/static/app.js?v={int(time.time())}')
    return HTMLResponse(busted)
